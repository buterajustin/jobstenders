...
<html lang="en" >
  <head>
    ...
    <title>Jobs & Tenders - Job List </title>
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="body-content clearfix" >
                        ...
                        <strong class="color-black">
                          <?php 
                            ...
                            if (!isset($title) AND !isset($district)) {
                              ...
                              $query=mysql_query("SELECT * FROM jobs WHERE deadline > $today");
                              $counting=mysql_query("SELECT count(id) as jbs FROM jobs WHERE deadline > $today");
                              $jnum=mysql_fetch_array($counting);
                              $jb=$jnum['jbs'];
                            }elseif (isset($title) AND $district!="") {
                              echo $title." Jobs Available in ".$district;
                              $query=mysql_query("SELECT * FROM jobs WHERE title LIKE '%$title%' AND district = '$district' AND deadline > $today");
                              $counting=mysql_query("SELECT count(id) as jbs FROM jobs WHERE title LIKE '%$title%' AND district = '$district' AND deadline > $today");
                              $jnum=mysql_fetch_array($counting);
                              $jb=$jnum['jbs'];
                            }elseif (isset($title) AND $district=="") {
                              echo $title." Jobs Available";
                              $query=mysql_query("SELECT * FROM jobs WHERE title LIKE '%$title%' AND deadline > $today");
                              $counting=mysql_query("SELECT count(id) as jbs FROM jobs WHERE title LIKE '%$title%' AND deadline > $today");
                              $jnum=mysql_fetch_array($counting);
                              $jb=$jnum['jbs'];
                            }elseif (!isset($title) AND $district!="") {
                              echo "All Jobs Available in ".$district;
                              $query=mysql_query("SELECT * FROM jobs WHERE district = '$district' AND deadline > $today");
                  ...
                  <div class="box-list">
                    ...
                    <div class="item">
                      <div class="row">
                        ...
                        <div class="col-md-11">
                          <h3 class="no-margin-top"><a href="job_details.php?id=<?php echo $row['id'];?>" class=""><?php echo $row['title'];?> <i class="fa fa-link color-white-mute font-1x"></i></a></h3>
                          ...
                          <div>
                            ...
                            <a href="#applying-modal" data-toggle="modal" class="btn btn-xs btn-theme btn-default">Apply</a> - 
        ...
        <!-- Modal applying -->
        <div class="modal fade" id="applying-modal">
          <div class="modal-dialog ">
            <div class="modal-content">
              <form action="applying_job.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  ...
                  <input type="hidden" name="job" value="<?php echo $id; ?>">
