...
$content .= '<h2>Your application has been reviewed</h2>';
$content .= '<p>After revising your document, your application is '.$mention.'</p>';
...
if (!$mail->send()) {
    ...
    echo "<script> alert('Revision Sent !!!');window.location.href='index.php'; </script>";
