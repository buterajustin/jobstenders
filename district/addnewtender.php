...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add New Tender</h1>
      <ol class="breadcrumb">
        <li><a href="index.php">Dashboard</a></li>
        <li class="active">Add New Tender</li>
      </ol>
        ...
        <div class="panel-title">
          ...
          <ul class="panel-tools">
            ...
            <div class="panel-body">
              <form class="form-horizontal" action="addingtender.php" method="POST">
